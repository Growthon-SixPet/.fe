  ...
  return (
    <header className="wt-header">
      <div className="wt-header-inner">
        ...
        >
          <img
            className="wt-left-logo"
            src="/images/header/brand-logo.png"
            alt="brand logo"
          />
          <img
            className="wt-brand-text-img"
            src="/images/header/brand-text.png"
            alt="WithTail"
          />
        </button>
